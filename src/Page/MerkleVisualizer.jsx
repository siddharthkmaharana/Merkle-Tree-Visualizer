...
import DataInput from '../Components/merkle/DataInput';
import TreeVisualization from '../Components/merkle/TreeVisualization';
import VerificationPanel from '../Components/merkle/VerificationPanel';
import ThemeToggle from '../Components/merkle/ThemeToggle';
import { buildMerkleTree } from '../utils/merkle';

export default function MerkleVisualizer() {
  const [blocks, setBlocks] = useState([
    { id: 1, value: 'Ledger Entry 1' },
    { id: 2, value: 'Ledger Entry 2' },
    { id: 3, value: 'Ledger Entry 3' },
    { id: 4, value: 'Ledger Entry 4' }
  ]);
  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${isDark ? 'bg-[#0a0a0a] text-gray-100' : 'bg-gray-50 text-gray-900'
      }`}>
      ...
      {/* Header */}
      <div className={`border-b transition-colors duration-300 ${isDark
        ...
        <div className="max-w-screen-2xl mx-auto px-6 py-6">
          ...
          >
            ...
            <div className="ml-auto flex items-center gap-3">
              <div className={`flex items-center gap-2 px-4 py-2 rounded-lg border ${isDark ? 'bg-[#1a1a1a] border-gray-800' : 'bg-white border-gray-300'
                }`}>
      ...
      <div className="max-w-screen-2xl mx-auto px-6 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          >
            <div className={`sticky top-6 p-6 rounded-xl border shadow-2xl transition-colors duration-300 ${isDark
          ...
          >
            <div className={`p-6 rounded-xl border shadow-2xl min-h-[600px] transition-colors duration-300 ${isDark
              ? 'bg-gradient-to-b from-[#1a1a1a] to-[#0f0f0f] border-gray-800'
              : 'bg-gradient-to-b from-white to-gray-50 border-gray-300'
              }`}>
        ...
        <motion.div
          ...
          className={`mt-8 p-6 rounded-xl border transition-colors duration-300 ${isDark
